...
class fullCard2 extends StatelessWidget {
  final String img;
  final String text;
  final String txt;
  const fullCard2({
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Manual &',style: TextStyle(fontSize: 16,color: Colors.white,height: 1,fontWeight: FontWeight.w600),),
                              Text('Automated Testing',style: TextStyle(fontSize: 16,color: Colors.white,height: 1,fontWeight: FontWeight.w600),),
                            ],
                          ),
                        ),
                      )
